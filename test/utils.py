...
PROMPT_NLU = os.path.join(os.path.dirname(__file__), "sys_prompt_NLU.txt")
PROMPT_DM = os.path.join(os.path.dirname(__file__), "sys_prompt_DM.txt")
PROMPT_NLG = os.path.join(os.path.dirname(__file__), "sys_prompt_NLG.txt")
